...
class TestMPVSocketCommunication:
    ...
    def test_update_mpv_subtitle_socket_error(self):
        ...
        with patch("socket.socket", return_value=mock_sock), \
             patch("jimaku_dl.downloader.exists", return_value=True), \
...
class TestSubtitleSynchronization:
    ...
    def test_sync_subtitles_process_error(self):
        ...
        with patch("jimaku_dl.downloader.JimakuDownloader.check_existing_sync", return_value=None), \
    ...
    def test_sync_subtitles_ffsubsync_not_found(self):
        ...
        with patch("jimaku_dl.downloader.JimakuDownloader.check_existing_sync", return_value=None), \
             patch("jimaku_dl.downloader.subprocess_run", side_effect=FileNotFoundError("No such file or command")):
...
class TestFileNameParsing:
    ...
    def test_find_anime_title_in_path_hierarchical(self):
        ...
        with patch.object(downloader, "parse_directory_name", mock_parse_directory_name):
